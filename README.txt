...
a persistence unit "adminlte-jsfPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "adminlte-jsf/pom.xml":
...
artifact ("adminlte-jsf.war") is already built. You can build
